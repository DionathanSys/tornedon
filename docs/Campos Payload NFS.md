**Nota:** Este serviço opera em modo Assincrono e requer 2 requisições  
**Requisição 1:** Envie a NFS-e utilizando o método /nfse, será feito uma analise dos dados informados e se tudo ocorrer bem, será devolvido um código 5023 - Lote em processamento  
**Requisição 2:** Aguarde aproximadamente 3 segundos, após isso deve ser realizado a consulta da NFS-e utilizando o método /nfse/{chave} (Esta chave é retornada no uso da requisição 1)  
  
**Nota:** Quando houver webhook configurado, a segunda requisição passa a ser opcional, pois o webhook retorna todos os dados do documento autorizado ou rejeitado após o processamento ser concluído.

Campos payload modelo NFS Municipal (Chapecó - SC)
{
...
- [tipo](https://integranotas.com.br/doc/nfse): {
    ...
    - [options](https://integranotas.com.br/doc/nfse): [
        1. "1 - Recibo Provisório de Serviços",
        2. "2 - RPS Nota Fiscal Conjugada (Mista)",
        3. "3 - Cupom"],
    - default: "1 - Recibo Provisório de Serviços"},
- [data_emissao](https://integranotas.com.br/doc/nfse): {
    - required: true,
    - type: "string",
    - description: "Data de emissão do RPS",
    - options: "ex. 2020-05-16T12:33:20-03:00"},
- [status](https://integranotas.com.br/doc/nfse): {
    - required: false,
    - [type](https://integranotas.com.br/doc/nfse): [
        1. "string",
        2. "null"],
    - description: "Situação do RPS",
    - [options](https://integranotas.com.br/doc/nfse): [
        1. "1 - Normal",
        2. "2 - Cancelado"],
    - default: "1 - Normal"},
- [data_competencia](https://integranotas.com.br/doc/nfse): {
    ...
    - [type](https://integranotas.com.br/doc/nfse): [
        1. "string",
        2. "null"],
    - description: "Data da prestação do serviço",
    - options: "ex. 2020-05-16T12:33:20-03:00",
...
- [incentivo_fiscal](https://integranotas.com.br/doc/nfse): {
    - required: false,
    - [type](https://integranotas.com.br/doc/nfse): [
        1. "boolean",
        2. "null"],
    - description: "Possui algum incentivo fiscal da Prefeitura",
    - [options](https://integranotas.com.br/doc/nfse): [
        1. "true - Sim",
        2. "false - Não"],
    - default: "false"},
- [tomador](https://integranotas.com.br/doc/nfse): {
    - [cnpj](https://integranotas.com.br/doc/nfse): {
        ...
        - [rules](https://integranotas.com.br/doc/nfse): [
            1. "Informar cnpj, cpf ou documento_estrangeiro"]},
    - [cpf](https://integranotas.com.br/doc/nfse): {
        ...
        - [rules](https://integranotas.com.br/doc/nfse): [
            1. "Informar cnpj, cpf ou documento_estrangeiro"]},
    - [documento_estrangeiro](https://integranotas.com.br/doc/nfse): {
        - required: false,
        - [type](https://integranotas.com.br/doc/nfse): [
            1. "string",
            2. "null"],
        - maxLength: 40,
        - description: "Identificação do Documento do estrangeiro",
    ...
    - [endereco](https://integranotas.com.br/doc/nfse): {
        ...
        - [codigo_pais](https://integranotas.com.br/doc/nfse): {
            ...
            - options: "4 digitos",
            - [rules](https://integranotas.com.br/doc/nfse): [
                1. "Indicar apenas se for uma exportação de serviço"]},
...
- [servico](https://integranotas.com.br/doc/nfse): {
    - [iss_retido](https://integranotas.com.br/doc/nfse): {
        ...
        - [options](https://integranotas.com.br/doc/nfse): [
            ...
            2. "false - Não"],
        - [rules](https://integranotas.com.br/doc/nfse): [
            1. "Normalmente ocorre apenas quando o serviço realizado fora do municipio, vide legislação da cidade"],
        - default: "false"},
    - [responsavel_retencao](https://integranotas.com.br/doc/nfse): {
        ...
        - [type](https://integranotas.com.br/doc/nfse): [
            1. "string",
            2. "null"],
        - description: "Responsável pela Retençao o ISS",
        - [options](https://integranotas.com.br/doc/nfse): [
            1. "1 - Tomador",
            2. "2 - Intermediário (indicar apenas quando o ISS ficou retido)"],
        - default: "1 - Tomador quando o campo iss_retido = true"},
    - [codigo_municipio](https://integranotas.com.br/doc/nfse): {
        - required: false,
        - [type](https://integranotas.com.br/doc/nfse): [
            1. "string",
            2. "null"],
        - description: "Código IBGE do município de incidencia do ISS",
        - options: "7 digitos"},
    - [codigo_municipio_prestacao](https://integranotas.com.br/doc/nfse): {
        ...
        - options: "7 digitos",
        - [rules](https://integranotas.com.br/doc/nfse): [
            1. "Se o serviço foi feito em outro pais indicar 9999999"],
    ...
    - [itens](https://integranotas.com.br/doc/nfse): [
        1. [](https://integranotas.com.br/doc/nfse){
            ...
            - [codigo_cnae](https://integranotas.com.br/doc/nfse): {
                - required: false,
                - [type](https://integranotas.com.br/doc/nfse): [
                    1. "string",
                    2. "null"],
            ...
            - [codigo_tributacao_municipio](https://integranotas.com.br/doc/nfse): {
                ...
                - [rules](https://integranotas.com.br/doc/nfse): [
                    1. "Consultar lista de códigos do seu municipio"]},
            - [codigo_nbs](https://integranotas.com.br/doc/nfse): {
                - required: true,
                - type: "string",
                - minLength: 1,
                - maxLength: 9,
                - description: "Código NBS para o Serviço Prestado",
            ...
            - [exigibilidade_iss](https://integranotas.com.br/doc/nfse): {
                - required: false,
                - [type](https://integranotas.com.br/doc/nfse): [
                    1. "string",
                    2. "null"],
                ...
                - default: "1 - Exigível"},
            - [numero_processo](https://integranotas.com.br/doc/nfse): {
                - required: false,
                - [type](https://integranotas.com.br/doc/nfse): [
                    1. "string",
                    2. "null"],
                ...
                - [rules](https://integranotas.com.br/doc/nfse): [
                    1. "Obrigatório e informado somente quando declarada a suspensão da exigibilidade do tributo. Ex. exigibilidade_iss = 6 ou 7"]},
            - [valor_servicos](https://integranotas.com.br/doc/nfse): {
                ...
                - options: "ex. 100.00"},
            - [valor_deducoes](https://integranotas.com.br/doc/nfse): {
                - required: false,
                - [type](https://integranotas.com.br/doc/nfse): [
                    1. "number",
                    2. "null"],
            ...
            - [valor_csll](https://integranotas.com.br/doc/nfse): {
                ...
                - options: "ex. 100.00"},
            - [valor_outras](https://integranotas.com.br/doc/nfse): {
                - required: false,
                - [type](https://integranotas.com.br/doc/nfse): [
                    1. "number",
                    2. "null"],
                ...
                - options: "ex. 100.00"},
            - [valor_iss](https://integranotas.com.br/doc/nfse): {
                - required: false,
                - [type](https://integranotas.com.br/doc/nfse): [
                    1. "number",
                    2. "null"],
                ...
                - options: "ex. 100.00"},
            - [valor_aliquota](https://integranotas.com.br/doc/nfse): {
                - required: false,
                - [type](https://integranotas.com.br/doc/nfse): [
                    1. "number",
                    2. "null"],
...
- [intermediario](https://integranotas.com.br/doc/nfse): {
    - [cnpj](https://integranotas.com.br/doc/nfse): {
        ...
        - [type](https://integranotas.com.br/doc/nfse): [
            1. "string",
            2. "null"],
        - description: "Número do CNPJ do intermediário do serviço",
        - options: "14 digitos",
        - [rules](https://integranotas.com.br/doc/nfse): [
    ...
    - [cpf](https://integranotas.com.br/doc/nfse): {
        ...
        - [type](https://integranotas.com.br/doc/nfse): [
            1. "string",
            2. "null"],
        - description: "Número do CPF do intermediário do serviço",
        - options: "11 digitos",
        - [rules](https://integranotas.com.br/doc/nfse): [
            1. "Informar cnpj ou cpf"]},
    - [im](https://integranotas.com.br/doc/nfse): {
        ...
        - [type](https://integranotas.com.br/doc/nfse): [
            1. "string",
            2. "null"],
        - description: "Número da inscrição municipal do intermediário do serviço",
        - options: "1 a 15 caracteres"},
    - [razao_social](https://integranotas.com.br/doc/nfse): {
        - required: true,
        - type: "string",
        - description: "Nome ou Razão Social do intermediário do serviço",
        - options: "1 à 150 caracteres"},
    - [codigo_municipio](https://integranotas.com.br/doc/nfse): {
        - required: true,
        - type: "string",
        - description: "Código IBGE do município do intermediário do serviço",
        - options: "7 digitos"}},
- [obra](https://integranotas.com.br/doc/nfse): {
    - [codigo](https://integranotas.com.br/doc/nfse): {
        ...
        - options: "1 a 30 caracteres",
        - [rules](https://integranotas.com.br/doc/nfse): [
            1. "Cadastro realizado pela Prefeitura - Matricula CEI (Cadastro Específico do INSS)"]},
    - [art](https://integranotas.com.br/doc/nfse): {
        - required: true,
        - type: "string",
        - description: "Número da ART",
        - options: "1 a 30 caracteres",
        - [rules](https://integranotas.com.br/doc/nfse): [
            1. "Anotação de Resonsabilidade Técnica - ART (fornecida pelo engenheiro ou arquiteto da obra)"]}}

}


----
Campos payload modelo NFS Nacional
...
- [tomador](https://integranotas.com.br/doc/nfse): {
    ...
    - [endereco](https://integranotas.com.br/doc/nfse): {
        ...
        - [cep](https://integranotas.com.br/doc/nfse): {
            ...
            - options: "8 digitos"},
        - [sigla_pais](https://integranotas.com.br/doc/nfse): {
            - required: false,
            - [type](https://integranotas.com.br/doc/nfse): [
                1. "string",
                2. "null"],
...
- [servico](https://integranotas.com.br/doc/nfse): {
    ...
    - [tributos_municipais](https://integranotas.com.br/doc/nfse): {
        ...
        - [suspensao](https://integranotas.com.br/doc/nfse): {
            - [tipo](https://integranotas.com.br/doc/nfse): {
                ...
                - [options](https://integranotas.com.br/doc/nfse): [
                    1. "1 - Exigibilidade Suspensa por Decisão Judicial",
                    2. "2 - Exigibilidade Suspensa por Processo Administrativo"]},
            - [numero](https://integranotas.com.br/doc/nfse): {
                - required: true,
                - type: "string",
    ...
    - [tributos_nacionais](https://integranotas.com.br/doc/nfse): {
        ...
        - [retido](https://integranotas.com.br/doc/nfse): {
            - required: false,
            - [type](https://integranotas.com.br/doc/nfse): [
                1. "boolean",
                2. "null"],
