...
class CompanyPartnerService
{
    ...
    private function buildCompanyPartnerPayload(CompanyPartner $sourceCompanyPartner): array
    {
        return [
            ...
            'notify_production_order_closed' => (bool) $sourceCompanyPartner->notify_production_order_closed,
            'notify_invoice_confirmed' => (bool) $sourceCompanyPartner->notify_invoice_confirmed,
