...
class StockMovementValidator
{
    ...
    private static function rules(): array
    {
        return [
            ...
            'operational_unit'  => 'nullable|string|max:6',
            'operational_quantity' => 'nullable|numeric|min:0.001',
            'base_unit'         => 'nullable|string|max:6',
            'base_quantity'     => 'nullable|numeric|min:0.001',
            'conversion_factor_snapshot' => 'nullable|numeric|gt:0',
    ...
    private static function messages(): array
    {
        return [
            ...
            'operational_unit.max'          => 'A unidade operacional não pode ter mais de 6 caracteres.',
            'operational_quantity.numeric'  => 'A quantidade operacional deve ser um número.',
            'operational_quantity.min'      => 'A quantidade operacional deve ser maior que zero.',
            'base_unit.max'                 => 'A unidade base não pode ter mais de 6 caracteres.',
            'base_quantity.numeric'         => 'A quantidade base deve ser um número.',
            'base_quantity.min'             => 'A quantidade base deve ser maior que zero.',
            'conversion_factor_snapshot.numeric' => 'O fator de conversão deve ser numérico.',
            'conversion_factor_snapshot.gt' => 'O fator de conversão deve ser maior que zero.',
