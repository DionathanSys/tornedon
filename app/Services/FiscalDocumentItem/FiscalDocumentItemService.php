...
class FiscalDocumentItemService
{
    ...
    public function create(array $data, int $createdBy): ?FiscalDocumentItem
    {
        ...
        try {
            ...
            $this->setError('Erro ao processar criação do item do documento fiscal');
    ...
    /**
     * Cria múltiplos itens em uma única operação (bulk insert).
     *
    ...
    public function createMany(array $items, int $createdBy): ?array
    {
        ...
        try {
            ...
            $this->setError('Erro ao processar criação dos itens do documento fiscal');
    ...
    public function delete(FiscalDocumentItem $fiscalDocumentItem): bool
    {
        ...
        try {
            return DB::transaction(function () use ($fiscalDocumentItem) {
                ...
                $this->setSuccess('Item do documento fiscal excluído com sucesso');

                Log::info('Item do documento fiscal excluído com sucesso via service', [
                    'metodo'                  => __METHOD__ . '@' . __LINE__,
                    'fiscal_document_item_id' => $fiscalDocumentItem->id,
                ]);
