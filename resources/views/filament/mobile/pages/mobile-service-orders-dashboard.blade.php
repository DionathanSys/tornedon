    ...
    <div class="space-y-4">
        <section class="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    <h2 class="text-base font-semibold text-zinc-900 dark:text-zinc-100">Data de referência</h2>
                </div>
            ...
            @else
                <div class="space-y-3 p-3">
                    @foreach ($this->orders as $order)
                        <a
                            href="{{ $order['edit_url'] }}"
                            class="block rounded-2xl border border-zinc-200 bg-zinc-50/60 px-6 py-5 shadow-sm transition hover:border-zinc-300 hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-300 dark:border-zinc-700 dark:bg-zinc-950 dark:hover:border-zinc-600 dark:hover:bg-zinc-900 dark:focus:ring-zinc-700"
                        >
                            <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                                <div class="min-w-0 space-y-4">
                                    ...
                                    <p class="text-base font-medium leading-6 text-zinc-800 dark:text-zinc-100">{{ $order['customer'] }}</p>
                                </div>
