<x-filament-panels::page>
    <style>
        ...
        .pr-mob-bottom { position: fixed; right: 0; bottom: 0; left: 0; z-index: 30; display: grid; grid-template-columns: 1fr 1.4fr; gap: .5rem; padding: .75rem max(.75rem, env(safe-area-inset-left)) max(.75rem, env(safe-area-inset-bottom)); border-top: 1px solid rgba(148, 163, 184, .25); background: rgba(248, 250, 252, .96); backdrop-filter: blur(14px); }
    ...
    <form wire:submit="save" class="pr-mob-form-page">
        ...
        <div class="pr-mob-bottom">
            <a href="{{ $this->getListUrl() }}" class="pr-mob-link">Voltar</a>
