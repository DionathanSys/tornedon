<x-filament-panels::page>
    <style>
        .pr-mob-form-page { display: grid; gap: 1rem; padding-bottom: 11rem; }
        ...
        .pr-mob-bottom { position: fixed; right: 0; bottom: calc(4.85rem + env(safe-area-inset-bottom)); left: 0; z-index: 60; display: grid; grid-template-columns: 1fr 1.4fr; gap: .5rem; padding: .75rem max(.75rem, env(safe-area-inset-left)); border-top: 1px solid rgba(148, 163, 184, .25); background: rgba(248, 250, 252, .96); backdrop-filter: blur(14px); }
